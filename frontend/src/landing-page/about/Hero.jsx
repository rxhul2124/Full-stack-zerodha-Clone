    ...
    return ( 
        <>
            <div className="container">
                <div className="row p-4 m-3 text-center aboutHero">
                    <h3>We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.</h3>
                </div>
                <hr className='opacity-25' />
                <div className="row p-4 m-3 mt-5 aboutHeroTextSection">
                    <div className="col-md-1"></div>
                    <div className="col-md-5 lh-lg aboutHeroLeftText">
                    ...
                    <div className="col-md-5 lh-lg aboutHeroRightText">
